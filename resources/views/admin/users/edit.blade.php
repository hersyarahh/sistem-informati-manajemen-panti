        ...
        <div class="border-t pt-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="hubungan"
                           value="{{ old('hubungan', $keluargaLansia?->hubungan) }}"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-gray-300"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                <div>
                    ...
                    <input type="text" name="keluarga_nama_lengkap"
                           value="{{ old('keluarga_nama_lengkap', $keluargaLansia?->nama_lengkap ?? $user->name) }}"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-gray-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                <div>
                    ...
                    <input type="email" name="keluarga_email"
                           value="{{ old('keluarga_email', $keluargaLansia?->email ?? $user->email) }}"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-gray-300">
                ...
                <div>
                    ...
                    <input type="text" name="keluarga_alamat"
                           value="{{ old('keluarga_alamat', $keluargaLansia?->alamat ?? $user->address) }}"
                           class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-gray-300">
