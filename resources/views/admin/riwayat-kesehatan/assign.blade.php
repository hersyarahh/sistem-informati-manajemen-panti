...
@section('title', 'Tentukan Staff')

@section('content')
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tentukan Staff</h1>
            <p class="text-sm text-gray-500">Pilih staff dan lansia yang ditugaskan</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.riwayat-kesehatan.assign.store') }}" class="bg-white rounded-lg shadow">
        ...
        <div class="p-4 border-b">
            ...
            <p class="text-sm text-gray-500">
                ...
                @else
                    Pilih staff terlebih dahulu untuk mengaktifkan checklist.
                @endif
            </p>
        </div>
