...
<body class="m-0 p-0 bg-gray-100 overflow-hidden">
    <div class="relative h-screen w-screen">
        ...
        <aside id="pekerja-sosial-sidebar"
            ...
            <nav class="flex flex-col space-y-4 px-5 flex-1">
                ...
                @php $isActive = request()->routeIs('pekerja-sosial.riwayat-kesehatan'); @endphp
                ...
                @php $isActive = request()->routeIs('pekerja-sosial.riwayat-kegiatan'); @endphp
        ...
        <main class="h-screen overflow-auto lg:pl-64">
            <div class="mx-auto w-full max-w-6xl px-4 py-6 sm:px-8 sm:py-8 flex flex-col gap-6">
                <div class="fixed left-4 top-4 z-50 flex items-center gap-3 lg:static lg:z-auto lg:hidden">
                    <button id="pekerja-sosial-sidebar-toggle" type="button"
                        class="inline-flex items-center justify-center rounded-lg bg-white p-2 text-gray-700 shadow hover:bg-gray-50"
                        aria-controls="pekerja-sosial-sidebar" aria-expanded="false">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                    </button>
                    <span id="pekerja-sosial-sidebar-label" class="hidden text-sm font-semibold text-gray-600">Menu Pekerja Sosial</span>
                </div>
                @yield('content')
            </div>
        </main>
    ...
    <script>
        (function () {
            const toggle = document.getElementById('pekerja-sosial-sidebar-toggle');
            const sidebar = document.getElementById('pekerja-sosial-sidebar');
            const overlay = document.getElementById('pekerja-sosial-sidebar-overlay');
            const label = document.getElementById('pekerja-sosial-sidebar-label');
